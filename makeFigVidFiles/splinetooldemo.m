function splinetooldemo(x, y)
% SPLINETOOLDEMO Reconstruct figure in SPLINETOOL.
%
%   SPLINETOOLDEMO(x, y) creates a plot, similar to the plot in SPLINETOOL,
...
% The same as spline(x,[0,y,0]).
spline1 = csape(x,[0,y,0],'complete'); 
